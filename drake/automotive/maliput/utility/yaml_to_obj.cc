...
int main(int argc, char* argv[]) {
  ...
  YAML::Node road_def = YAML::LoadFile(FLAGS_yaml_file);

  DRAKE_DEMAND(road_def.IsMap());
  YAML::Node mmb = road_def["maliput_monolane_builder"];
