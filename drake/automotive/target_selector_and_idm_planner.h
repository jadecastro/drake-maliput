...
template <typename T>
class TargetSelectorAndIdmPlanner : public systems::LeafSystem<T> {
 public:
  explicit TargetSelectorAndIdmPlanner(
  ...
  ~TargetSelectorAndIdmPlanner() override;
  ...
  // System<T> overrides.
  // The output of TargetSelectorAndIdmPlanner is an algebraic
